...
from app.ui.views.multi_users_view import MultiUsersView
from app.ui.views.dashboard_view import DashboardView
from app.ui.views.at_jobs_view import ATJobsView
...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.btn_at_jobs     = QPushButton("Jobs AT")
        ...
        for w in [titulo, self.btn_dashboard, self.btn_listas,
                  ...
                  self.btn_at_jobs, self.btn_operaciones, self.btn_bitacora]:
            menu.addWidget(w)
        menu.addStretch()
        ...
        # Dashboard es la fuente del manager compartido
        self.dashboard_view    = DashboardView()
        self.server_lists_view = ServerListsView()
        self.servers_view      = ServersView()
        self.audit_log_view    = AuditLogView()
        self.users_view        = MultiUsersView(self.dashboard_view.get_manager)
        self.at_jobs_view      = ATJobsView(self.dashboard_view.get_manager)

        self.pages.addWidget(self.dashboard_view)      # 0
        ...
        self.pages.addWidget(self.at_jobs_view)        # 5
        ...
        self.btn_at_jobs.clicked.connect(lambda: self.pages.setCurrentIndex(5))
